...
import org.odesar.mapa_biocultural_interactivo_san_dionisio.databinding.FragmentInfoTabBinding
...
class InfoTabFragment(var infoAdicional : InformacionAdicional) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val customContext =
            requireActivity().createPackageContext("org.odesar.mapa_biocultural_interactivo_san_dionisio", 0)
